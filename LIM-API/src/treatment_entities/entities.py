...
class Treatmentinput:
    ...
    acceptable_answer : bool = True # returns false if no treatment works

    complete_treatment : bool = True # determines whether only the mandatory treatments or all treatments will be used
